...
const BADGE_MAP: Record<TargetType, { bg: string; color: string }> = {
  ALL: { bg: '#FFFBEB', color: '#D97706' },
...
@Component({
  ...
  template: `
    <div class="page">
      <div class="page-header">
        ...
        <p class="page-sub">Notices from your institute</p>
      </div>
  ...
  styles: [`
    ...
    .ann-card { background: white; border-radius: 12px; border: 1px solid #E2E8F0; display: flex; overflow: hidden; transition: box-shadow 0.15s; }
...
export class ParentAnnouncementsComponent implements OnInit {
  ...
  badge(t: TargetType) { return BADGE_MAP[t] ?? BADGE_MAP['ALL']; }
