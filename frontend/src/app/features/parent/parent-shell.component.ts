...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'My Children', icon: 'family_restroom', route: '/parent/children' },
  { label: 'Attendance', icon: 'fact_check', route: '/parent/attendance' },
  { label: 'Assignments', icon: 'assignment', route: '/parent/assignments' },
  { label: 'Exams', icon: 'quiz', route: '/parent/exams' },
  { label: 'Fees', icon: 'payments', route: '/parent/fees' },
  { label: 'Announcements', icon: 'campaign', route: '/parent/announcements' },
];
...
@Component({
        ...
        <nav class="sidebar-nav">
          @for (item of navItems; track item.route) {
            <a class="nav-item"
               ...
               [routerLinkActiveOptions]="{ exact: item.route === '/parent' }"
  ...
  styles: [`
    ...
    /* Sidebar — amber/orange parent accent */
    .sidebar {
    ...
    .role-badge {
      ...
      font-size: 0.75rem; color: #FCD34D; font-weight: 600;
    ...
    .nav-item.active { background: #92400E; color: #FEF3C7; }
    ...
    .avatar { width: 36px; height: 36px; border-radius: 50%; background: #92400E; color: #FEF3C7; font-size: 0.8rem; font-weight: 700; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
