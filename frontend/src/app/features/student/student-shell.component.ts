...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'My Classes', icon: 'menu_book', route: '/student/courses' },
  ...
  { label: 'Fees', icon: 'payments', route: '/student/fees' },
...
@Component({
        ...
        <nav class="sidebar-nav">
          @for (item of navItems; track item.route) {
            <a class="nav-item"
               ...
               [routerLinkActiveOptions]="{ exact: item.route === '/student' }"
  ...
  styles: [`
    ...
    /* Sidebar — indigo/violet student accent */
    .sidebar {
    ...
    .nav-item.active { background: #4338CA; color: #E0E7FF; }
    ...
    .avatar { width: 36px; height: 36px; border-radius: 50%; background: #4338CA; color: #E0E7FF; font-size: 0.8rem; font-weight: 700; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
